...
export type SubjectBeforeFilterTuple<Subject = AnyObject, Request = AuthorizableRequest> = [AnyClass, (service: InstanceType<AnyClass>, request: Request) => Promise<Subject>];
