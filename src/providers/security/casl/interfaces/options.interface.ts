...
import { AuthorizableUser, Permission } from "./authorizable-user.interface";
...
// export interface OptionsForRootAsync<Roles extends string = string, User extends AuthorizableUser = AuthorizableUser<Roles>, Request = AuthorizableRequest<User>>
