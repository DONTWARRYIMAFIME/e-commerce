...
export const IsHexColorI18N = (validationOptions?: ValidationOptions) =>
  IsHexColor({ ...validationOptions, message: i18nValidationMessage("validation.IS_HEX_COLOR") });
export const IsSnakeCaseI18N = (validationOptions?: ValidationOptions) =>
  IsSnakeCase({ ...validationOptions, message: i18nValidationMessage("validation.IS_SNAKE_CASE") });
export const IsUpperCaseI18N = (validationOptions?: ValidationOptions) =>
  IsUppercase({ ...validationOptions, message: i18nValidationMessage("validation.IS_UPPER_CASE") });
...
export const IsBigIntI18N = (validationOptions?: ValidationOptions) =>
  IsBigInt({ ...validationOptions, message: i18nValidationMessage("validation.IS_BIG_INT") });
export const IsBooleanI18N = (validationOptions?: ValidationOptions) =>
  IsBoolean({ ...validationOptions, message: i18nValidationMessage("validation.IS_BOOLEAN") });
export const IsNotEmptyI18N = (validationOptions?: ValidationOptions) =>
  IsNotEmpty({ ...validationOptions, message: i18nValidationMessage("validation.IS_NOT_EMPTY") });
